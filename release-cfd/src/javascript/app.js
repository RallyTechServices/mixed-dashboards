Ext.define("TSReleaseCFDWithCommonSelector", {
    ...
    integrationHeaders : {
        name : "TSReleaseCFDWithCommonSelector"
    },
    ...
    _getStoriesForRelease: function() {
        var release = this.release;
        
        var release_filter = Rally.data.wsapi.Filter.or([
            // TODO: get Feature field name from settings
            {property:'Feature.Release.ObjectID',operator:'contains',value:release.get('ObjectID')},
            {property:'Release.ObjectID',operator:'contains',value:release.get('ObjectID')}
        ]);
        ...
        var config = {
            model: 'UserStory',
            filters: child_filter.and(release_filter),
    ...
    _getChartConfig: function() {
        ...
        return {
            ...
            calculatorType: 'Rally.techservices.ReleaseCFDCalculator',
            calculatorConfig: {
