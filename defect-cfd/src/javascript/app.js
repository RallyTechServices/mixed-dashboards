...
//            showScopeSelector:  true,
    ...
    _updateData: function(timebox) {
        ...
        Deft.Chain.parallel([
            this._getArtifactStates,
            this._getArtifactsForMilestone
        ],this).then({
            scope: this,
            success: function(results) {
                ...
                this.artifact_oids = Ext.Array.map(artifacts, function(artifact) {
                    return artifact.get('ObjectID');
                });
    ...
    _getArtifactsForMilestone: function() {
        ...
        var config = {
            model: 'Defect',
            filters: milestone_filter, //child_filter.and(milestone_filter),
    ...
    getSettingsFields: function() {
        ...
        return [
            ...
            // },
            {
                ...
                fieldLabel: '',
                margin: '0 0 25 200',
                boxLabel: 'Show by Count<br/><span style="color:#999999;"><i>Tick to use count.  Otherwise, uses points.</i></span>'
            },
            {
